...
class GoodsType(BaseModel):
	...
	logd = models.CharField(max_length=20,verbose_name='logo')
...
# 	goods_type = models.ForeignKey('GoodsType',verbose_name='商品种类')
...
class IndexGoodsBanner(BaseModel):
	...
	index = models.SmallIntegerField(default = 0,verbose_name = '轮播顺序')# 0 1 2 3 4 5 
...
class IndexTypeGoodsBanner(BaseModel):
	'''首页分类商品展示'''
	DISPLAY_TYPE =((0,'标题'),(1,'图片'))

	type = models.ForeignKey('GoodsType',verbose_name='商品类型')
	sku = models.ForeignKey('GoodsSKU',verbose_name='商品SKU')
	display_type = models.SmallIntegerField(default=1,choices=DISPLAY_TYPE,verbose_name='展示类型')
